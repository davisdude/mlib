...
context( 'vector', function()
	...
	context( 'getMidpoint', function()
		context( 'mlib', function()
			test( 'Gives the midpoint of two points with formats of line.getSlope', function()
				assert_multipleFuzzyEqual( mlib.vector.getMidpoint( 0, 0, 2, 2 ), { 1, 1 } )
				assert_multipleFuzzyEqual( mlib.vector.getMidpoint( { 0, 0 }, { 2, 2 } ), { 1, 1 } )
				assert_multipleFuzzyEqual( mlib.vector.getMidpoint( { 0, 0 }, 2, 2 ), { 1, 1 } )
				assert_multipleFuzzyEqual( mlib.vector.getMidpoint( 0, 0, { 2, 2 } ), { 1, 1 } )
				assert_error( function() mlib.vector.getMidpoint( 0, 0, '2', 2 ) end )
			end )
			test( 'Errors if compatibilityMode is true', function()
				mlib.compatibilityMode = true
				assert_error( function() mlib.vector.getMidpoint( { 0, 0 }, 2, 2 ) end )
		...
		context( 'turbo', function()
			test( 'Gives the midpoint of two points given two points', function()
				assert_multipleFuzzyEqual( turbo.vector.getMidpoint( { 0, 0 }, { 2, 2 } ), { 1, 1 } )
			end )
		end )
	end )
	-- }}}
	...
	context( 'getLength', function()
		context( 'mlib', function()
			test( 'Gets the distance between two points with formats of vector.getSlope', function()
				assert_fuzzyEqual( mlib.vector.getLength( 0, 0, 1, 1 ), math.sqrt( 2 ) )
				assert_fuzzyEqual( mlib.vector.getLength( { 0, 0 }, { 1, 1 } ), math.sqrt( 2 ) )
				assert_fuzzyEqual( mlib.vector.getLength( { 0, 0 }, 1, 1 ), math.sqrt( 2 ) )
				assert_fuzzyEqual( mlib.vector.getLength( 0, 0, { 1, 1 } ), math.sqrt( 2 ) )
				assert_error( function() mlib.vector.getLength( 0, '0', 1, 1 ) end )
			end )
			test( 'Errors if compatibilityMode is true', function()
				mlib.compatibilityMode = true
				assert_error( function() mlib.vector.getLength( { 0, 0 }, 1, 1 ) end )
		...
		context( 'turbo', function()
			test( 'Gets the distance between two points given two points', function()
				assert_fuzzyEqual( turbo.vector.getLength( { 0, 0 }, { 1, 1 } ), math.sqrt( 2 ) )
			end )
		end )
	end )
	-- }}}
