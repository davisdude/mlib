	...
	context( 'line', function()
		context( 'getSlope', function()
			...
			test( 'Errors if the given input is incorrect', function()
				...
				assert_error( function() mlib.line.getSlope( { 1, 1 }, 0, 0, { 1, 0 } ) end )
			end )
		end )
		...
		context( 'getPerpendicularSlope', function()
			...
			test( '0 if the line is vertical', function()
				assert_equal( mlib.line.getPerpendicularSlope( 0, 0, 0, 1 ), 0 )
				assert_equal( mlib.line.getPerpendicularSlope( 50, 30, 50, 20 ), 0 )
			end )
		...
		context( 'getLineLineIntersection', function()
		end )
	end )
end )
