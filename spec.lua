	...
	context( 'line', function()
		...
		context( 'getYIntercept', function()
			test( 'Gives the y-intercept given two points.', function()
				assert_fuzzy_equal( _.line.getYIntercept( 0, 0, 1, 1 ), 0 )
				assert_fuzzy_equal( _.line.getYIntercept( 2, 3, 4, 9 ), -3 )
			end )
			
			test( 'Gives the y-intercept given one point and the slope.', function()
				assert_fuzzy_equal( _.line.getYIntercept( 0, 0, 1 ), 0 )
			end )
			
			test( 'Returns the x if the slope is false.', function()
				assert_fuzzy_equal( _.line.getYIntercept( 1, 0, 1, 5 ), 1 )
				assert_fuzzy_equal( _.line.getYIntercept( 0, 0, false ), 0 )
			end )
		end )
	...
	context( 'math', function()
		...
		context( 'getPercentOfChange', function()
			test( 'Gives the percentage of change.', function()
				assert_equal( _.math.getPercentOfChange( 2, 4 ), 100 )
				assert_equal( _.math.getPercentOfChange( 4, 2 ), -50 )
				assert_equal( _.math.getPercentOfChange( 4, 0 ), -100 )
